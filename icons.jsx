...
const I = {
  ...
  Google: (p) => (
    <svg viewBox="0 0 24 24" {...p}>
      ...
      <path fill="#FBBC04" d="M5.84 14.1A6.59 6.59 0 0 1 5.5 12c0-.73.13-1.44.34-2.1V7.07H2.18A10.997 10.997 0 0 0 1 12c0 1.77.42 3.44 1.18 4.93l3.66-2.83z"/>
  ...
  Receipt: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <path d="M4 2v20l3-2 3 2 3-2 3 2 3-2 1 2V2"/><line x1="8" y1="7" x2="16" y2="7"/><line x1="8" y1="11" x2="16" y2="11"/><line x1="8" y1="15" x2="13" y2="15"/>
    </svg>
  ),
  Coins: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
